    ...
    if(imgXFile==null){
      ...
      if(passwordController.text==confirmPassController.text){
            ...
            confirmPassController.text.isNotEmpty)
        {
          ...
          fStorage.Reference reference=fStorage.FirebaseStorage.instance.ref().child('usersImages').child(fileName);
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                child: ReusebleText(text: "Sign UP",fontWeight: FontWeight.bold,color: Colors.white,)
            ),
